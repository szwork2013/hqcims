...
<head>
    ...
    <script type="text/javascript">
        ...
        function doSubmit1(){
            window.location="${ctx}/cms/main/importlist";
        }
        function doSubmit3(){
            var id=$("#id").val();
        ...
        function doSubmit2(){
            var mess="确认要提交吗？";
            var url="${ctx}/cms/importCart/saveOrder?id="+$("#id").val();;
        ...
        function doSubmit(){
            ...
            if(status==3||status==0){
                var url="${ctx}/cms/importCart/saveList";
...
<ul class="nav nav-tabs">
		<li class="active"><a>进货车管理</a></li>
</ul>
<form:form id="searchForm" modelAttribute="returns" action="${ctx}/cms/importCart/" method="post">
    <form:hidden path="id"/>
</form:form>
<div class="breadcrumb form-search">
    <input id="selectButton" class="btn btn-primary" type="button" value="更改客户"/>
    <label>客户名称：</label>
    <input id="consumer_name" name="consumer.name" type="text" value="${returns.consumer.name}"  readonly/>
    <input id="consumer_id" name="consumer.id" type="hidden" value="${returns.consumer.id}"/>
</div>
...
<div class="form-actions">
    <div align="center">
        ...
        <input id="btnButton"  class="btn btn-primary" type="button" value="确认进货" onclick="doSubmit2()"/>
        <input id="btnButton"  class="btn btn-primary" type="button" value="清空进货车" onclick="doSubmit3()"/>
    </div>
</div>
